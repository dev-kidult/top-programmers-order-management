...
public class Review {
    ...
    public Review(Long seq, Long userSeq, Long productSeq, String content, LocalDateTime createAt) {
        ...
        checkArgument(productSeq != null, "productSeq must be provided");
        checkArgument(isNotEmpty(content) && content.length() <= 1000,
                "content must be provided and less then 1000 characters");
        this.seq = seq;
